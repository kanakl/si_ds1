<?php
/**
 * Toto je LOKALNI LEFTMENU. Prepisuje defaultni verzi.
 */
?>
<!-- start menu vlevo -->
<div class="sidebar">
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            <li class="nav-title">Údržba systému</li>
            <li class="nav-item">
                <a class="nav-link" href="<?php echo $base_url_link;?>user_manager"><i class="nav-icon icon-people"></i> Uživatelé</a>
            </li>
            ...
            <?php
                ...
                foreach ($modules_admin as $admin_module) {
                    ...
                    // tohle nemusi uplne fungovat, chybi tam index.php i kdyz ho tam chci
                    //$module_url = $controller->makeUrlByRoute("modul_".$admin_module["name"]); // vychazi ze skriptu routes_admin, kde je definovan zpusob pojmenovani

                    echo "<li class=\"nav-item\">
                        <a class=\"nav-link\" href=\"$base_url_link.$admin_module[route_path]\"><i class=\"nav-icon icon-puzzle\"></i> $admin_module[title]</a>
                    </li>";
                }
            ?>
