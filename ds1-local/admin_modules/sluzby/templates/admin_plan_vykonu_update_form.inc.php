<div class="container-fluid">
    ...
    <form method="post" action="<?php echo $form_submit_url; ?>">
        <input type="hidden" name="action" value="<?php echo $form_action_update_plan_vykonu; ?>"/>
        <input type="hidden" name="typ_id" value="<?php echo $plan_id; ?>" />
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        Editace plánu výkonu #<?php echo $plan_id;?>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <?php
                            ...
                            //$text_columns["typ_planu"] = "typ planu"; TODO - to by slo jako pri vytvareni

                            $text_columns["cas_od"] = "cas od";
                            $text_columns["cas_do"] = "cas do";

                            // definice, ktera pole jsou datumy
                            $dates_text_columns_keys = array();

                            $times_text_columns_keys = array();
                            $times_text_columns_keys["cas_od"] = "ano";
                            $times_text_columns_keys["cas_do"] = "ano";
                            ...
                            if ($text_columns != null) {
                                ...
                                foreach ($text_columns as $key => $value) {
                                    ...
                                    echo "<input type=\"$input_type\" class=\"form-control\" name=\"plan_vykonu[$key]\" value=\"".$plan_vykonu[$key]."\" />";
                                    echo "</td>";
                                    echo "<td class='w-30'>";
                                    // napoveda
                                ...
                                foreach ($textarea_columns as $key => $value) {
                                    ...
                                    echo "<td class='w-75'>
                                                <textarea class=\"form-control\" name=\"plan_vykonu[$key]\" rows='7'>$plan_vykonu[$key]</textarea>
                                              </td>";
                                    echo "</tr>";
                                }
